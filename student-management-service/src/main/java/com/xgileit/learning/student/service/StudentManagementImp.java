    ...
    * this way makes everythings easier
    ...
    public void addStudent() {
        ...
        for (int i = 0; i < numberStudent; i++) {
           System.out.println("Please enter any key number");
           student.setKey(scanner.nextInt());
            ...
            studentList.put(student.getKey(), new Student(student.getStudentId(), student.getFirstName(), student.getLastName(), student.getPhoneNumber(), student.getGender(), student.getAge(), student.getAddress()));
        }
    ...
    public void updateStudent() {
        ...
        studentList.replace(2,  new Student(student.getStudentId(), "Dimpho", "Moetanalo", 112532, "Female", (short) 23, "Witbank"));
